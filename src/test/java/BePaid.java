...
public class BePaid {
    ...
    private By button = By.xpath("/html/body/app-root/div/div/div/app-payment-container/section/div/app-card-page/div/div[1]/button");
    ...
    public CardInfo getCardInfo() {
        ...
        String cvcCode = driver.findElement(cvc).getText();
        String nameCard = driver.findElement(name).getText();
        return new CardInfo(number, validPeriod, cvcCode, nameCard);
    }
    ...
    public List<WebElement> getCardsBrands() {
        return driver.findElements(cardsBrands);
    }
}
